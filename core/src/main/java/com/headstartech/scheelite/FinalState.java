...
/**
 * Represents a final state. No transitions from the state are allowed. No events will be handled. Nothing done on exit (can exit the final state if it's a substate).
 *
